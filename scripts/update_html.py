...
def main():
    ...
    # 生成 JS 数据 - 使用 ensure_ascii=True 确保所有字符都是 ASCII
...
<script>
var news=''')
    html_parts.append(news_js)
    html_parts.append(''';
var audioFiles=''')
    html_parts.append(audio_js)
    html_parts.append(''';
var ytVideos=''')
    html_parts.append(yt_js)
    html_parts.append(''';
var spotifyShows=''')
    html_parts.append(shows_js)
    html_parts.append(''';
var spotifyEpisodes=''')
    html_parts.append(episodes_js)
    html_parts.append(''';
